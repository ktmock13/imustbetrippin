  ...
  return (
      <div className={classes.Container} >
          ...
          <div className={classes.Content}>
              <div className={`${classes.SubContent} ${videoLoaded ? classes.ShowOnFinish: ''}` } >
                  <h1 className={classes.Title}>I must be trippin.</h1>
                  <Link className={classes.Link}to={'/trips'}> <span> go to trips </span></Link>
              </div>
              <div className={`${classes.RainbowSubContent} ${videoLoaded ? classes.HideOnFinish: ''}` } >
                  <h1 className={classes.RainbowTitle}>I must be trippin.</h1>
                  <Link className={classes.RainbowLink}to={'/trips'}> <span> go to trips </span></Link>
              </div>
          </div>
      </div>
  )
